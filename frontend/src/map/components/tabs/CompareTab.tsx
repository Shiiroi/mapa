...
import { ComparePicker } from "./compare-sections/ComparePicker";
import { MetricRow } from "./compare-sections/MetricRow";
import { CompareSection } from "./compare-sections/CompareSection";
import { type CompareSelection, DEFAULT_SELECTION } from "./compare-sections/types";
...
export function CompareTab({
    ...
    }, [displayA, displayB, activeOverlay]);
...
function resolveComparePlace(
    ...
    ctx: Omit<CompareTabProps, "currentSelection" | "currentSelectionName"> & {
